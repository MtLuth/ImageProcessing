...
from tkinter import Canvas, Frame, Button, Label, Entry, filedialog
...
class MainDisplay:
    def __init__(self):
        ...
        self.camera_button = Button(self.upper_right_frame, text='Chụp Camera 0', command=self.capture_image)
        ...
        self.camera_button_lower = Button(self.lower_right_frame, text='Chụp Camera 1', command=self.capture_image_lower)
        self.camera_button_lower.pack(side='right')
        
        self.lower_camera_image = Canvas(self.lower_right_frame, width=500, height=400, bg='white')
        self.lower_camera_image.pack()
        
        self.clock_label = Label(self.root, text="", font=("Arial", 50), fg="blue")
        self.clock_label.pack(side='top', pady=(50, 0))
        self.update_clock()
        
        self.parking_fee_label = Label(self.root, text="Tiền gửi xe: 0 VNĐ", font=("Arial", 20))
        self.parking_fee_label.pack(side='top', pady=(20, 0))
        
        self.card_number_entry = Entry(self.root, font=("Arial", 20))
        self.card_number_entry.pack(side='top', pady=(20, 0))
        
        self.parking_info_label = Label(self.root, text="Chỗ đậu xe còn trống: 50", font=("Arial", 15))
        self.parking_info_label.pack(side='top', pady=(20, 0))
        ...
        self.open_video_button = Button(self.root, text='Chọn Video', command=self.open_video)
        self.open_video_button.pack(side='top', pady=(20, 0))
